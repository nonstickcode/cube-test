    ...
    return (
        <div id='pwned-checker-container' className="container">
            ...
            <div className="form-container">
                ...
                {result && <p className="result-text" style={{ color: result.includes("compromised") ? 'red' : 'green' }}>{result}</p>}
            </div>
            ...
            {isModalOpen && (
                <div className="modal" onClick={() => setModalOpen(false)}>
                    <div className="modal-content" onClick={e => e.stopPropagation()}>
                        ...
                        <p>This tool leverages the "Have I Been Pwned" API to determine if a password has previously been exposed in data breaches...</p>
                    </div>
                </div>
            )}
        </div>
